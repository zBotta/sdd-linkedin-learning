...
- Python 3.11+ + FastAPI, Streamlit, Playwright, BERTopic, sentence-transformers, Podman Compose, sqlite3 (003-deployment-e2e-validation)
- Canonical cloud SQLite plus local sync checkpoint files (003-deployment-e2e-validation)
...
## Recent Changes
- 003-deployment-e2e-validation: Added Python 3.11+ + FastAPI, Streamlit, Playwright, BERTopic, sentence-transformers, Podman Compose, sqlite3
